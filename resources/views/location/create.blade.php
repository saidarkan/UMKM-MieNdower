            ...
            <form action="{{ route('locations.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        ...
                        <input type="text" id="nama_lokasi" name="nama_lokasi" value="{{ old('nama_lokasi') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    ...
                    <div>
                        ...
                        <input type="text" id="alamat_lokasi" name="alamat_lokasi" value="{{ old('alamat_lokasi') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
                    ...
                    <div>
                        ...
                        <input type="url" id="link_lokasi" name="link_lokasi" value="{{ old('link_lokasi') }}" class="mt-1 block w-full border-gray-300 rounded-md" required>
